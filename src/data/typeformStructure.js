export const typeFormStructure = [
  ...
  },
  {
    ...
    disclaimer: "[ 🔴DEVELOPER NOTICE: Options in the questions ahead depend on this question's response/s. ]",
    type: "option",
  ...
  },
  {
    ...
    intro: "",
    type: "option",
    options: ["Get hired", "Get promoted", "Connect with like-minded people", "Structured approach to growth", "Build a growth team"],
    optionCount: 1,
    optionLabel: "goal"
  },
  {
    ...
    intro:"We will keep all our communications with you through this email. Do check your spam inbox if you can't find our application received email.",
    disclaimer: "[ 🔴DEVELOPER NOTICE: Responses submitted to this form will be forwarded to the email you input here, for you to test data submissions. ]",
    type: "text",
    questionType: "email",
  },
  {
